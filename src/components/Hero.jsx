  ...
  return (
    <section id="home" className="relative h-screen">
      ...
      <div className="relative z-10 max-w-[1240px] mx-auto h-full px-6">
        <div className="absolute left-6 md:left-24 lg:left-40 right-6 md:right-auto bottom-16 md:bottom-24 lg:bottom-32 md:max-w-[430px]">
          <h1
            className="
              text-white
              text-[28px] md:text-[32px]
              font-extrabold
              leading-[38px] md:leading-[50px]
              uppercase
            "
            style={{
          ...
          <p className="text-white mt-6 text-[15px] leading-7">
